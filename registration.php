...
<head>
    ...
    <title>SIGNUP | Techstraa - AIT Kanpur</title>
    ...
    <div id="page" class="site">
        ...
        <div class="header-tilte">
            ...
            <div id="content" class="site-content">
                ...
                <div class="grad"></div>
                <div class="header">
                    <div style="margin-right: 5px;">Techstraa<span>2k19</span></div>
                </div>
                <br>
                <div class="login">
                    ...
                    <form action="register.php" method="post" id="main_form">
                        ...
                        <input type="text" placeholder="Full Name" name="name" maxlength="20" required />
                        <span style="color : red; font-size:12px;">* <?php echo $_SESSION['name_error']; ?></span><br>

                        <input type="email" placeholder="Email" name="email" required>
                        <span style="color : red; font-size:12px;">* <?php echo  $_SESSION['email_error']; ?></span><br>
                        
                        <select class="select" name="course" form="main_form" >
                        
                            <option value="B.TECH.">COURSE</option>
                        ...
                        <input type="password" placeholder="Confirm Password" name = "cnf_pwd" required />
                        <span style="color : red; font-size:12px;">* <?php echo $_SESSION['cnfPassword_error'] ?></span><br>

                        <input type="submit" value="Register"><br><br>
                        <span style="color : red; font-size:14px;margin-left:200px;"><?php echo $_SESSION['registration_error']; ?></span>
                    </form>
                            ...
                            <aside class="sidebar footer-sidebar" itemscope="itemscope" itemtype="http://schema.org/WPSideBar">
                                <aside id="text-2" class="widget widget_text">
                                    <div class="textwidget">
                                        ...
                                        <div style="text-align: center; color: #ffffff;">+91 9517133041/+91 9580590287
                                        </div>
                                ...
                                <aside id="text-4" class="widget widget_text">
                                    <div class="textwidget">
                                        ...
                                        <div style="text-align: center; color: #ffffff;">
                                            <strong><em>admin@techstraa2k19.com
                                                </em></strong></div>
                                        <div style="text-align: center; color: #ffffff;">
